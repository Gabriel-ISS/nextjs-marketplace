...
export default function Search({ className }: Props) {
  ...
  return (
    <div className={`${style.search} ${className || ''}`}>
      <input className={style.search__input} type="text" name="search" value={search} placeholder="Buscar productos en PC Clicks" onChange={handleInput} onKeyDown={handleEnter} />
