import CartButton from '@/product/_components/CartButton'
import Price from '@/_reusable_components/Price'
import styles from '@/product/_components/Product.module.scss'
